define('./workbox-a1b75552.js', ['exports'], function (t) {
  'use strict'
  try {
  ...
  class P {
    constructor(t) {
      ;(this.m = f(t)), (this.O = new Map()), (this.K = new Map()), (this.M = new Map())
    }
    addToCacheList(t) {
      const e = []
      for (const n of t) {
    ...
    async install({ event: t, plugins: e } = {}) {
      ...
      for (const [t, e] of this.O) a.has(e) ? n.push(t) : s.push({ cacheKey: e, url: t })
    ...
    async P({ cacheKey: t, url: e, cacheMode: n, event: i, plugins: r, integrity: a }) {
  ...
  ;(t.CacheFirst = class {
    ...
    (t.ExpirationPlugin = class {
      constructor(t = {}) {
        ...
        ;(this.cachedResponseWillBeUsed = async ({
          ...
          (this.I = new Map()),
          t.purgeOnQuotaError && ((e = () => this.deleteCacheAndMetadata()), d.add(e))
      }
      S(t) {
      ...
      async deleteCacheAndMetadata() {
        for (const [t, e] of this.I) await self.caches.delete(t), await e.delete()
        this.I = new Map()
      }
    }),
    (t.NetworkFirst = class {
      ...
      async j({ timeoutId: t, request: e, logs: s, event: n }) {
        ...
        if ((t && clearTimeout(t), i || !r)) r = await this.G({ request: e, event: n })
        else {
          const t = r.clone(),
            s = x({
              cacheName: this.m,
    ...
    (t.StaleWhileRevalidate = class {
      constructor(t = {}) {
        if (((this.m = w(t.cacheName)), (this.T = t.plugins || []), t.plugins)) {
          const e = t.plugins.some((t) => !!t.cacheWillUpdate)
          this.T = e ? t.plugins : [O, ...t.plugins]
        } else this.T = [O]
    ...
    (t.precacheAndRoute = function (t, e) {
      !(function (t) {
        D().addToCacheList(t),
          t.length > 0 &&
            (self.addEventListener('install', I), self.addEventListener('activate', W))
      })(t),
        A(e)
    }),
